...
function display_latest_aiovg_videos() {
    $args = array(
...
add_shortcode('latest_aiovg_videos', 'display_latest_aiovg_videos');


function list_categories_from_custom_post_type_shortcode($atts) {
    $tags = get_terms( 'aiovg_tags', array(
    'hide_empty' => false,
    'category_slus' => 'education'
) );

  if ($tags) {
        $output = '<ul>';
        foreach ($tags as $category) {
            $output .= '<li>' . $category->name . '<a href="' . get_permalink() . '">' . $category->name . '</a></li>';
        }
        $output .= '</ul>';
    } else {
...
add_shortcode('custom_post_type_categories', 'list_categories_from_custom_post_type_shortcode');